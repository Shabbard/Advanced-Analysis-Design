...
namespace AdvancedAnalysisDesign.Migrations
{
    ...
    [Migration("20210216002944_change-test-result-to-bool")]
    partial class changetestresulttobool
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvancedAnalysisDesign.Models.Database.PatientBloodworkTest", b =>
                {
                    b.HasOne("AdvancedAnalysisDesign.Models.Database.PatientBloodwork", "PatientBloodwork")
                        .WithMany("PatientBloodworkTests")
                        .HasForeignKey("PatientBloodworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PatientBloodwork");
                });
